...
static int
l_version (lua_State *l __attribute__((unused)))
{
  /* Calls the C function hello_fish and prints the result. */
  printf ("%s\n", version ());
...
static int
l_package (lua_State *l __attribute__((unused)))
{
...
static int
l_bugreport (lua_State *l __attribute__((unused)))
{
...
static int
l_license (lua_State *l __attribute__((unused)))
{
...
static int
l_help (lua_State *l __attribute__((unused)))
{
...
int
load_lua_script (const char *scriptname)
{
